...
FUNCTION AGTOOL_Glob()
   RETURN { "name" => "glob", ;
            ...
            "parameters" => { "type" => "object", ;
               ...
               "required" => { "pattern" } }, ;
            "handler" => {| hArgs | AGTOOL_GlobRun( hArgs ) } }

STATIC FUNCTION AGTOOL_GlobRun( hArgs )
...
FUNCTION AGTOOL_Grep()
   RETURN { "name" => "grep", ;
            ...
            "parameters" => { "type" => "object", ;
               ...
               "required" => { "pattern" } }, ;
            "handler" => {| hArgs | AGTOOL_GrepRun( hArgs ) } }

STATIC FUNCTION AGTOOL_GrepRun( hArgs )
